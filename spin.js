; (function (undefined) {
    ...
    SpinLoading.prototype = {
        ...
        _generateTemplate: function (elem) {
            ...
            return docContainer;//控制这个div 去close 与show spin
        },
        show: function () {
